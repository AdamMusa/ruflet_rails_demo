# -*- encoding: utf-8 -*-
# stub: ruflet_rails 0.0.13 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<ruflet>.freeze, [">= 0.0.16".freeze])
  s.add_runtime_dependency(%q<ruflet_core>.freeze, [">= 0.0.16".freeze])
  s.add_runtime_dependency(%q<ruflet_server>.freeze, [">= 0.0.16".freeze])
end
